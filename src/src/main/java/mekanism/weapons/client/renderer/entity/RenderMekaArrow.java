   ...
   public class RenderMekaArrow
   extends RenderArrow<EntityMekaArrow> {
   public static final ResourceLocation arrow = new ResourceLocation("mekaweapons", "textures/entities/meka_arrow.png");
