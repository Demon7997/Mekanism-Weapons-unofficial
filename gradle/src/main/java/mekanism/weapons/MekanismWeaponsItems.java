...
public class MekanismWeaponsItems {
    ...
    @ObjectHolder(MekanismWeapons.MODID + ":magnetizer")
    public static final ItemMagnetizer magnetizer = null;
    ...
    public static void registerItems(IForgeRegistry<Item> registry) {
        ...
        registry.register(init(new ItemMagnetizer(), "magnetizer"));
